function Interest({interest, key, removeInterest}) {

  return (
    <>
      <span className="interest" key={key}>
        {interest}
        <button aria-label="close" type="button" className="remove-interest-btn" onClick={() => removeInterest(interest)}>
